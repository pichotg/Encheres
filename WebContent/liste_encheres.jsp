...
<h1>ENI - Enchères</h1>
	...
	<c:forEach var="enchere" items="${listeEncheres}">
		...
		<div class="enchere">
			...
			<label for="vendeur" >Vendeur : <a target ="_blank" value="disabled" href="<%=request.getContextPath()%>/profil?id_utilisateur_recherche=${enchere.noArticle.utilisateur.noUtilisateur}">${enchere.noArticle.utilisateur.pseudo}</a></label><br/>
		</div>
		</section>
	</c:forEach>
	</section>
